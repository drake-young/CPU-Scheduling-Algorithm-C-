...
//
//*********************************************************
bool RRQueue::enqueue(dataType dataValue) {
...
//	Data out:	boolean. Returns true if successful
//				or false if it fails
//	Task:		shift the nodes in the queue, so that the
//				head now points to the second node, and the
//				previous head is now the end of the list, 
//				pointing to nullptr
//
//*********************************************************
bool RRQueue::cycle() {
	if (headPtr == nullptr) {
		...
		// no need to cycle if headptr is only item in queue
		...
		// move headptr to end
		currentPtr->setNext(headPtr);

		// shift the head
		headPtr = headPtr->getNext();

		// make the end of the list point to nullptr
		currentPtr->getNext()->setNext(nullptr);
